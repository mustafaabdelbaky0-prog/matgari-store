      ...
      return `
        <div class="field" data-multi-field data-attr-key="${esc(attr.key)}">
          ...
          <div style="display:flex;gap:6px;align-items:stretch;">
            <input type="text" class="ml-input" placeholder="اكتب قيمه واضغط Enter"
              style="flex:1;min-width:0;border:1.5px solid var(--border,#e5e7eb);border-radius:10px;padding:8px 12px;font-family:inherit;font-size:14px;box-sizing:border-box;">
            <button type="button" class="ml-add" style="flex:0 0 auto;width:auto;background:var(--brand,#4F46E5);color:#fff;border:none;padding:8px 18px;border-radius:10px;font-weight:700;cursor:pointer;font-size:13px;white-space:nowrap;">إضافه</button>
          </div>
          ${suggestions.length ? `
