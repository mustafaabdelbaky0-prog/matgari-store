...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* What-is section */
  .whatis { background: linear-gradient(180deg, #FAFAFF 0%, #FFFFFF 100%); padding: 80px 24px; border-top: 1px solid var(--line); border-bottom: 1px solid var(--line); }
  .whatis-inner { max-width: 1180px; margin: 0 auto; }
  .whatis-head { text-align: center; margin-bottom: 50px; }
  .whatis-head h2 { font-size: 38px; font-weight: 900; margin: 0 0 14px; letter-spacing: -0.02em; }
  .whatis-head h2 .accent { background: linear-gradient(135deg, var(--brand), var(--accent)); -webkit-background-clip: text; background-clip: text; color: transparent; }
  .whatis-head p { font-size: 18px; color: var(--ink-2); max-width: 640px; margin: 0 auto; line-height: 1.75; }
  .whatis-pillars { display: grid; grid-template-columns: repeat(3, 1fr); gap: 22px; margin-bottom: 50px; }
  .pillar { background: #fff; border: 1px solid var(--line); border-radius: 16px; padding: 26px 22px; text-align: center; }
  .pillar .ic { width: 56px; height: 56px; border-radius: 14px; display: flex; align-items: center; justify-content: center; font-size: 26px; margin: 0 auto 14px; }
  .pillar.a .ic { background: rgba(79,70,229,.10); color: var(--brand); }
  .pillar.b .ic { background: rgba(236,72,153,.10); color: var(--accent); }
  .pillar.c .ic { background: rgba(16,185,129,.10); color: var(--success); }
  .pillar h3 { font-size: 18px; font-weight: 800; margin: 0 0 8px; }
  .pillar p { font-size: 14.5px; color: var(--ink-2); margin: 0; line-height: 1.7; }
  .persona-title { text-align: center; font-size: 22px; font-weight: 800; margin: 0 0 28px; color: var(--ink); }
  .personas { display: grid; grid-template-columns: repeat(3, 1fr); gap: 18px; }
  .persona { background: #fff; border: 1.5px solid var(--line); border-radius: 18px; padding: 24px 22px; transition: transform .15s, border-color .15s, box-shadow .15s; }
  .persona:hover { transform: translateY(-4px); border-color: rgba(79,70,229,.35); box-shadow: var(--shadow-md); }
  .persona .avatar { font-size: 42px; margin-bottom: 12px; }
  .persona .who { font-size: 16px; font-weight: 800; color: var(--brand); margin: 0 0 6px; }
  .persona .prob { font-size: 14px; color: var(--ink-2); margin: 0 0 12px; line-height: 1.7; }
  .persona .sol { font-size: 14px; color: var(--ink); background: #F1F5F9; border-radius: 10px; padding: 10px 12px; line-height: 1.65; }
  .persona .sol strong { color: var(--brand); }
  .vs-fb { margin-top: 50px; background: #fff; border: 1.5px solid var(--line); border-radius: 18px; padding: 28px; }
  .vs-fb h3 { font-size: 20px; font-weight: 800; margin: 0 0 20px; text-align: center; }
  .vs-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 22px; }
  .vs-col { padding: 20px; border-radius: 14px; }
  .vs-col.old { background: #FEF2F2; border: 1px solid #FECACA; }
  .vs-col.new { background: #ECFDF5; border: 1px solid #A7F3D0; }
  .vs-col h4 { margin: 0 0 12px; font-size: 15px; font-weight: 800; }
  .vs-col.old h4 { color: #991B1B; }
  .vs-col.new h4 { color: #065F46; }
  .vs-col ul { margin: 0; padding-inline-start: 20px; }
  .vs-col li { font-size: 14.5px; margin: 8px 0; line-height: 1.6; }
  .vs-col.old li { color: #7F1D1D; }
  .vs-col.new li { color: #064E3B; }
  @media (max-width: 900px) {
    .whatis-pillars, .personas, .vs-grid { grid-template-columns: 1fr; }
    .whatis-head h2 { font-size: 28px; }
  }
...
<section class="whatis" id="whatis">
  <div class="whatis-inner">
    <div class="whatis-head">
      <h2>يعني إيه <span class="accent">متجري</span>؟</h2>
      <p>متجري تطبيق بيديك كل حاجه محتاجها علشان تفتح متجر أونلاين احترافي وتبدأ تبيع فيه في نفس اليوم — من غير مبرمج، من غير موقع، من غير كارت ائتمان.</p>
    </div>

    <div class="whatis-pillars">
      <div class="pillar a">
        <div class="ic">🏪</div>
        <h3>متجر جاهز بلينك</h3>
        <p>بتدخل، بتضيف منتجاتك، وبتلاقي لينك متجرك جاهز تبعته لأي حد على واتساب أو فيسبوك.</p>
      </div>
      <div class="pillar b">
        <div class="ic">📦</div>
        <h3>إداره كامله للمخزون</h3>
        <p>فواتير مشتريات ومبيعات، خزنه، ومخزون لكل مقاس بالتفصيل — كل حاجه في مكان واحد.</p>
      </div>
      <div class="pillar c">
        <div class="ic">💬</div>
        <h3>طلبات عبر واتساب</h3>
        <p>العميل بيدوس "اطلب" فبيتفتحله واتساب برساله فيها التفاصيل كلها — أنت بترد وتشحن.</p>
      </div>
    </div>

    <h3 class="persona-title">متجري مناسب ليك لو أنت…</h3>
    <div class="personas">
      <div class="persona">
        <div class="avatar">👩</div>
        <div class="who">تاجره لسه بادئه</div>
        <p class="prob">عندك فكره مشروع ومنتج تحبي تبيعيه، بس مش عارفه تبدأي منين ولا معاكي فلوس لمصمم موقع.</p>
        <div class="sol"><strong>الحل:</strong> افتحي متجرك في 5 دقايق مجانًا وابدأي تسوّقي على فيسبوك بلينك جاهز.</div>
      </div>
      <div class="persona">
        <div class="avatar">📱</div>
        <div class="who">بائع/ه على فيسبوك</div>
        <p class="prob">بتبيع على البيدج، بس تعبان من الكومنتات والرسايل والملفات المبعزقه. مفيش سجل واضح لمخزونك أو أرباحك.</p>
        <div class="sol"><strong>الحل:</strong> انقل المنتجات لمتجري، وسيب البيدج للتسويق فقط. الطلبات هتيجي منظمه على واتساب.</div>
      </div>
      <div class="persona">
        <div class="avatar">🏬</div>
        <div class="who">صاحب/ه محل</div>
        <p class="prob">عندك محل شغال، بس عاوز توسع وتوصل لعملاء أكتر من الأونلاين، ومحتاج تعرف مبيعاتك ومخزونك بدقه.</p>
        <div class="sol"><strong>الحل:</strong> اربط المحل بمتجرك الأونلاين، وشوف أرباحك ومخزونك من موبايلك في أي وقت.</div>
      </div>
    </div>

    <div class="vs-fb">
      <h3>ليه متجري مش زي بيدج فيسبوك؟</h3>
      <div class="vs-grid">
        <div class="vs-col old">
          <h4>❌ بيدج فيسبوك لوحده</h4>
          <ul>
            <li>الرسايل بتضيع في الـ Inbox</li>
            <li>مفيش سله ولا تفاصيل طلب واضحه</li>
            <li>مفيش سجل لمخزونك أو أرباحك</li>
            <li>البيدج ممكن يتقفل والعملاء يضيعوا</li>
            <li>الفيس بيقلل الوصول لبوستاتك</li>
          </ul>
        </div>
        <div class="vs-col new">
          <h4>✅ متجري + بيدجك</h4>
          <ul>
            <li>لينك متجر احترافي تبعته لأي حد</li>
            <li>الطلب بيوصلك على واتساب بكل التفاصيل</li>
            <li>مخزون وفواتير وأرباح مسجله بدقه</li>
            <li>البيانات ملكك ومحفوظه بأمان</li>
            <li>البيدج شغال للتسويق، ومتجري شغال للبيع</li>
          </ul>
        </div>
      </div>
    </div>
